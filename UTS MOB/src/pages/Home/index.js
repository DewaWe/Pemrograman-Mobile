            ...
            <ScrollView>
                <TouchableOpacity onPress={() => handleGoTo('Post')}>
                    <View style={styles.postHeader}>
                        <Image
                            ...
                            source={{ uri: 'https://sujeitoprogramador.com/wp-content/uploads/2019/03/como.png', }}
                        />
                ...
                <TouchableOpacity onPress={() => handleGoTo('Post2')}>
                    <View style={styles.postHeader}>
                        <Image
                            style={styles.imgPerfil}
                            source={{ uri: 'https://sujeitoprogramador.com/wp-content/uploads/2019/02/js.png', }}
                        />
                        <Text style={styles.username}>
                            Sujeito Programador
                        </Text>
                ...
                <TouchableOpacity onPress={() => handleGoTo('Post3')}>
                    <View style={styles.postHeader}>
                        <Image
                            style={styles.imgPerfil}
                            source={{ uri: 'https://sujeitoprogramador.com/wp-content/uploads/2019/01/coverCodeEdit.png', }}
                        />
                        <Text style={styles.username}>
                            Luana Souza
                        </Text>
                ...
                <TouchableOpacity>
                    <View style={styles.postHeader}>
                        <Image
                            style={styles.imgPerfil}
                            source={{ uri: 'https://images.pexels.com/photos/1428787/pexels-photo-1428787.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', }}
                        />
                        <Text style={styles.username}>
                            Eren Yeager
                        </Text>
                ...
                <TouchableOpacity>
                    <View style={styles.postHeader}>
                        <Image
                            style={styles.imgPerfil}
                            source={{ uri: 'https://images.pexels.com/photos/4124073/pexels-photo-4124073.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', }}
                        />
                        <Text style={styles.username}>
                            Mikasa Ackerman
                        </Text>
                ...
                <TouchableOpacity>
                    <View style={styles.postHeader}>
                        <Image
                            style={styles.imgPerfil}
                            source={{ uri: 'https://images.pexels.com/photos/4275890/pexels-photo-4275890.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', }}
                        />
                        <Text style={styles.username}>
                            Hange Zoe
                        </Text>
                ...
                <TouchableOpacity>
                    <View style={styles.postHeader}>
                        <Image
                            style={styles.imgPerfil}
                            source={{ uri: 'https://images.pexels.com/photos/4275885/pexels-photo-4275885.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', }}
                        />
                        <Text style={styles.username}>
                            Armin Arlert
                        </Text>
                ...
                <TouchableOpacity>
                    <View style={styles.postHeader}>
                        <Image
                            style={styles.imgPerfil}
                            source={{ uri: 'https://images.pexels.com/photos/1497302/pexels-photo-1497302.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', }}
                        />
                        <Text style={styles.username}>
                            Reiner Braun
                        </Text>
